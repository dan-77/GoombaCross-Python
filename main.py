...
def main():
    ...
    startzone = pySprites.Grass(screen, 480, 1)
    midzone = pySprites.Grass(screen, 270, 2)
    endzone = pySprites.Grass(screen, 70, 1)
    water = pySprites.Water(screen)
    ...
    for row in range(1):
        for column in range(2):
            rocket1 = pySprites.Rockets(screen, row, column, 1)
    ...
    for row in range(1):
        for column in range(2):
            lilypad1 = pySprites.Lilypads(screen, row, column, 1)
    ...
    for row in range(2):
        for column in range(2):
            rocket2 = pySprites.Rockets(screen, row, column, 2)
    ...
    for row in range(2):
        for column in range(4):
            lilypad2 = pySprites.Lilypads(screen, row, column, 2)
    ...
    for row in range(3):
        for column in range(2):
            rocket3 = pySprites.Rockets(screen, row, column, 3)
    ...
    for row in range(3):
        for column in range(4):
            lilypad3 = pySprites.Lilypads(screen, row, column, 3)
